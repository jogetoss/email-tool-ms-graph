 ...
 * Given a form's details and a specific field ID, will extract the file uploaded in that field
 * also provides other info about the form like their 'FormRowSet'
 */
public class FileAndFormExtraction {
    ...
    public File getFile(String fileField, String tableName)
    {
        ...
        */
        ...
        try
        {
            if(formRowSet != null && !formRowSet.isEmpty())
            {
                ...
                for(FormRow r : formRowSet)
                {
                    ...
                    LogUtil.info("Files String, name", files);
                    ...
                    if(files != null && !files.isEmpty())
                    {
                        ...
                        for(String path : file_paths)
                        {
                            ...
                            {
                                LogUtil.info("File detected", "True");
                                return file;
                            }
                        }
                    }
        ...
        {
            LogUtil.error("Error", e, "File handling error");
        }
    ...
    public String getFileBase64(File file)
    {
        ...
        */
        ...
        {
            LogUtil.error("Error", e, "File encoding error");
        } 
